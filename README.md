# LaboratorySteelBeamModelUpdating
...
The code includes implementation of TMCMC (transitional Markov chain Monte Carlo) and BPT (Bayesian pattern search, doi: 10.1016/j.ymssp.2024.112259))
